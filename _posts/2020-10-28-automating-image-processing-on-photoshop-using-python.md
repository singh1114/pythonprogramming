...
The scenario described for generating an image might seem very simple, **why use Photoshop at all, right?** 
...
As mentioned at the beginning, we will be using the Photoshop COM programming interface.
